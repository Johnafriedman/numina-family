 ...
 * commands.
 */
var cordova = require('www/www.numina.org/js/vendor/cordova'),
...
channel.join(function() {
    ...
    // side.
    channel.join(function() {
        require('www/www.numina.org/js/vendor/cordova').fireDocumentEvent('deviceready');
...
window.cordova = require('www/www.numina.org/js/vendor/cordova');
