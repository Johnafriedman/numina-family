...
{return IWCreatePhotocast("http://www.katefriedman.com/site_10.8.10/uniformhiero2_files/rss.xml",true);}
...
{var registry=IWCreateEffectRegistry();registry.registerEffects({stroke_0:new IWStrokeParts([{rect:new IWRect(-1,1,2,28),url:'uniformhiero2_files/stroke.png'},{rect:new IWRect(-1,-1,2,2),url:'uniformhiero2_files/stroke_1.png'},{rect:new IWRect(1,-1,960,2),url:'uniformhiero2_files/stroke_2.png'},{rect:new IWRect(961,-1,2,2),url:'uniformhiero2_files/stroke_3.png'},{rect:new IWRect(961,1,2,28),url:'uniformhiero2_files/stroke_4.png'},{rect:new IWRect(961,29,2,2),url:'uniformhiero2_files/stroke_5.png'},{rect:new IWRect(1,29,960,2),url:'uniformhiero2_files/stroke_6.png'},{rect:new IWRect(-1,29,2,2),url:'uniformhiero2_files/stroke_7.png'}],new IWSize(962,30))});registry.applyEffects();}
function hostedOnDM()
{return false;}
function onPageLoad()
{IWRegisterNamedImage('comment overlay','Media/Photo-Overlay-Comment.png')
IWRegisterNamedImage('movie overlay','Media/Photo-Overlay-Movie.png')
loadMozillaCSS('uniformhiero2_files/uniformhiero2Moz.css')
...
adjustLineHeightIfTooBig('id6');adjustFontSizeIfTooBig('id6');fixAllIEPNGs('Media/transparent.gif');Widget.onload();applyEffects()
